...
# EXPERIMENT_NAME=fullconv/complete_data/dmfa_mse_10_eps_v3

# ARGS="--experiment_name ${EXPERIMENT_NAME} --dataset svhn --img_size 32 --mask_hidden_w 16 --mask_hidden_h 16 \
...
# # incomplete data
# EXPERIMENT_NAME=fullconv/incomplete_data/dmfa_mse_10_eps_v3
