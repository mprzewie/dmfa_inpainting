...
EXPERIMENTS_DIR=tryout_dropout_smaller_cls_val_size_0

DEFAULT_ARGS="--batch_size=64 --dataset cifar10  --img_size 32 --mask_train_size 0 --mask_unknown_size 16 --mask_val_size 0 --num_epochs=35 --lr=1e-4 \
...
# python train_classifier_v2.py \
#     --experiment_name=$EXPERIMENTS_DIR/dmfa_fc_comp_ctd \
#     --inpainter_type=dmfa --inpainter_path ../results/inpainting/cifar10/fullconv/complete_data/dmfa_mse_10_eps_v2_ctd/ $DEFAULT_ARGS 

# python train_classifier_v2.py \
#     --experiment_name=$EXPERIMENTS_DIR/dmfa_fc_comp_ctd_cnv \
#     --inpainter_type=dmfa --inpainter_path ../results/inpainting/cifar10/fullconv/complete_data/dmfa_mse_10_eps_v2_ctd/ $DEFAULT_ARGS \
#     --convar_type naive
